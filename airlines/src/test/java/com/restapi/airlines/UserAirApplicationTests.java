...
//        assertThat(createUser.getStatusCode().is2xxSuccessful()).isEqualTo(true);
//    }
//
//    @Test
//    public void getUser() {
...
//        assertThat(getUser.getStatusCode().is2xxSuccessful()).isEqualTo(true);
//    }
//
//    @Test
...
//        assertThat(getAllUser.getStatusCode().is2xxSuccessful()).isEqualTo(true);
//    }
//
//    @Test
...
//        assertThat(updatePhoneNumUser.getStatusCode().is2xxSuccessful()).isEqualTo(true);
//    }
//
//    @Test
...
//        assertThat(deleteUser.getStatusCode().is2xxSuccessful()).isEqualTo(true);
//
//        log.info("------------ Delete User Success -------------");
//    }
//
